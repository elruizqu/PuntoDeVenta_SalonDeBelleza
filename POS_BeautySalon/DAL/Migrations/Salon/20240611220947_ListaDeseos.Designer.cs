...
namespace DAL.Migrations.Salon
{
    ...
    [Migration("20240611220947_ListaDeseos")]
            ...
            modelBuilder.Entity("DAL.Producto", b =>
                {
                    ...
                    b.Property<int?>("ListaDeseoListaID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Producto", b =>
                {
                    ...
                    b.HasOne("DAL.ListaDeseo", null)
                        .WithMany("Productos")
                        .HasForeignKey("ListaDeseoListaID");
